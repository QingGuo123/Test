angular.module('SSNoC', []).controller('homePageController', function ($scope, $http, $location) {
        ...
        //     $scope.userdisable = false;
        //
        //     if(userlen <3 || savekeywords || passwordlen<4){
        //     	if((userlen <3 || savekeywords) && !(passwordlen<4) ){
        //             $scope.userdisable = true;
        //
        //             if (userlen < 3){
        ...
        //             $scope.userdisable = true;
        //
        //             if (userlen < 3 && passwordlen<4){
        //                 return "Username should have at least three characters and Password should have more than four characters";
        //             }
        //             if (savekeywords && passwordlen<4) {
        //                 return "Username matches saved keywords, please use another name and Password should have more than four characters";
        //             }
			// 	}
			// 	if(!(userlen <3 || savekeywords) && (passwordlen<4)){
        //             $scope.passworddisable = true;
